...
class TraderAITestSuite:
    ...
    async def test_market_overview(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                if "market_sentiment" in data and "top_gainers" in data and "top_losers" in data:
                    self.log_test_result(test_id, test_name, "PASS", 
    ...
    async def test_risk_management(self):
        ...
        try:
            ...
            risk_metrics = risk_manager.calculate_portfolio_risk(portfolio_data['positions'], portfolio_data['total_value'])
            
            if risk_metrics and ('var_1d' in risk_metrics or 'portfolio_value' in risk_metrics):
                self.log_test_result(test_id, test_name, "PASS", 
